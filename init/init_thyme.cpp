...
void load_thyme() {
    property_override("ro.product.model", "M2102J2SC");
    property_override("ro.build.product", "thyme");
    property_override("ro.product.device", "thyme");
    property_override("ro.product.marketname", "Mi 10S");
}
